...
def main():
    ...
    p.add_argument("--fine-pred", default="runs/v3_yolo11s_seg_960_e100/validation_predictions.json")
    p.add_argument("--coarse-pcm", default="runs/v3_hier_coarse_yolo11s_seg_960_e50/per_class_metrics.csv")
